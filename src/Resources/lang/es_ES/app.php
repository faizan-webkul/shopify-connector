...
return [
    ...
    'export' => [
        'schedule' => [
            ...
            'presets' => [
                ...
                'daily-6am'        => 'Diariamente a las 6:00 (0 6 * * *)',
    ...
    'exporters' => [
        'shopify' => [
            ...
            'metaobjects' => 'Metaobjetos de Shopify',
        ],
    ],
    'importers' => [
        'shopify' => [
    ...
    'components' => [
        'layouts' => [
            'sidebar' => [
                ...
                'metaobjects'           => 'Definiciones de metaobjetos',
            ],
        ],
    ],
    'shopify' => [
        'external-media' => [
            ...
            'video'       => 'Atributo de URL de vídeo',
            'video-info'  => 'Un atributo de URL con enlaces de YouTube o Vimeo. Shopify no aloja ningún otro servicio de vídeo.',
            'unsupported' => ':sku: se omitieron :count enlaces de vídeo, solo se admiten YouTube y Vimeo.',
        ...
        'realtime' => [
            ...
            'blocked' => [
                'locale'   => 'La sincronización en tiempo real solo funciona cuando esta credencial tiene una configuración regional predeterminada.',
                'settings' => 'La sincronización en tiempo real solo funciona cuando el canal y la moneda están definidos en los ajustes de sincronización en tiempo real.',
            ],

            'settings-saved'      => 'Se guardaron los ajustes de sincronización en tiempo real.',
        ...
        'catalogs' => [
            ...
            'form' => [
                ...
                'price-attribute-info'               => 'El atributo de precio de UnoPim con el que vende este catálogo, como un precio de distribuidor. Déjelo vacío para usar el atributo de precio del mapeo de exportación.',
                'compare-at-attribute'               => 'Atributo de precio de comparación',
                'compare-at-attribute-info'          => 'El atributo de precio de UnoPim que se muestra tachado junto al precio de este catálogo. Déjelo vacío para usar el precio de comparación del mapeo de exportación.',
                'include-compare-at'                 => 'Incluir precio de comparación',
                'include-compare-at-info'            => 'Envía el precio de comparación a la lista de precios de este catálogo. Desactívalo para publicar solo el precio.',
                'include-compare-at-adjustment-info' => 'Aplica también el ajuste porcentual del catálogo al precio de comparación. Desactívelo para dejar este catálogo sin precios de comparación.',
            ],
            ...
            'export' => [
                'no-market'     => 'El catálogo :catalog no tiene mercado, así que Shopify no tiene nada que tarificar.',
        ...
        'pro' => [
            ...
            'media-note'                => 'Los atributos de URL de imagen y vídeo están disponibles en Shopify Pro.',
            ...
            'comparison' => [
                'title'        => 'Edición Community frente a Pro',
                'intro'        => 'Lo que el conector ofrece por sí solo y lo que añade Shopify Pro.',
                'feature'      => 'Función',
                'community'    => 'Community',
                'pro'          => 'Pro',
                'included'     => 'Incluido',
                ...
                'groups' => [
                    'transfer'   => 'Importación y exportación',
                ...
                'features' => [
                    'product'          => 'Exportación e importación de productos',
                    'category'         => 'Sincronización de categorías y colecciones',
                    'metafield'        => 'Definiciones y valores de metacampos',
                    'metaobject'       => 'Definiciones y entradas de metaobjetos',
                    'attribute-import' => 'Importación de atributos y familias',
                    'base-filters'     => 'Filtrar una exportación por canal, moneda, SKU y estado',
                    'base-mapping'     => 'Asignación de atributos a campos de Shopify',
                    'manual-run'       => 'Ejecutar una exportación o importación cuando se necesite',
                    'base-price'       => 'Precio del producto desde la asignación de exportación',
                    'catalogs'         => 'Catálogos y precios de catálogo',
                ],
            ],
        ],
        ...
        'acl' => [
            ...
            'saas-credentials' => 'Credenciales SaaS',
            'metaobject'       => [
                'save'   => 'Guardar metaobjeto',
                'edit'   => 'Editar metaobjeto',
                'delete' => 'Eliminar metaobjeto',
            ],
            'metaobject-entry' => [
                'save'   => 'Guardar entrada de metaobjeto',
                'delete' => 'Eliminar entrada de metaobjeto',
            ],
        ],
        ...
        'attribute' => [
            ...
            'metaobject-type'             => 'Metaobjeto de Shopify',
            'metaobject-binding'          => 'Metaobjeto',
            'metaobject-required'         => 'Seleccione un metaobjeto para este atributo.',
        ],
        'credential' => [
            'export' => [
        ...
        'export' => [
            ...
            'mapping' => [
                ...
                'collection' => [
                    ...
                    'errors' => [
                        ...
                        'asset_missing'   => 'Imagen de la colección omitida para la categoría :code: el recurso asignado ya no existe.',
                        'asset_not_image' => 'Imagen de la colección omitida para la categoría :code: el recurso asignado no es una imagen.',
                        'asset_extra'     => 'La categoría :code asigna :count recursos más; una colección de Shopify admite una imagen.',
                        'asset_failed'    => 'Imagen de la colección omitida para la categoría :code: no se pudo subir el recurso a Shopify.',
                    ],
                    'images' => [
            ...
            'errors' => [
                ...
                'metaobject-definition-missing'  => 'La definición de metaobjeto ":type" no existe en la tienda :store. Sincronice la definición con esta tienda antes de exportar.',
                'metaobject-definition-failed'   => 'No se pudo exportar la definición de metaobjeto ":code".',
                'metaobject-entry-failed'        => 'No se pudo exportar la entrada de metaobjeto ":code".',
                'metaobject-reference-unmapped'  => 'Referencia de metaobjeto omitida, no se encontró ninguna asignación de Shopify para el identificador: :identifier',
            ],
        ],
        'import' => [
            'variant-level-skipped' => 'Se omitió :fields en la variante :sku: el atributo pertenece a un nivel superior de su estructura de variantes.',
            'mapping'               => [
        ...
        'metafield' => [
            ...
            'index' => [
                ...
                'accepted-file-types'  => 'Tipos de archivo admitidos',
                'any-file-type'        => 'Cualquier tipo de archivo',
                'media-file-only'      => 'Solo archivos multimedia',
                'metaobject'           => 'Metaobjeto',
                'metaobject-attribute' => 'Atributo de metaobjeto',
            ],
            'type' => [
                'single_line_text_field' => 'Texto de una línea',
                'id'                     => 'ID',
